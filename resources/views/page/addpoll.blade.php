<x-guest-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
            ...
            <ul x-data="candidate" class="w-64 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                <template x-for="candidate in candidates" :key="candidate.id">
                   
                <li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input id="vue-checkbox"  @click="check(candidate.id)" type="checkbox" x-model="candidate.checked" value="" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        <img class="ml-4 w-8 h-8 rounded" src="{{asset('blogImages/baby.jpeg')}}" alt="Default avatar">
                        <label for="vue-checkbox" class="py-3 ml-2 w-full text-sm font-medium text-gray-900 dark:text-gray-300" x-text="candidate.name"></label>
                    </div>
                </li>
                ...
                <li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input id="react-checkbox" type="checkbox" value="" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        <img class="ml-4 w-8 h-8 rounded" src="{{asset('blogImages/baby.jpeg')}}" alt="Default avatar">
                ...
                <li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input id="angular-checkbox" type="checkbox" value=""  class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        <img class="ml-4 w-8 h-8 rounded" src="{{asset('blogImages/baby.jpeg')}}" alt="Default avatar">
                ...
                <li class="w-full rounded-t-lg border-b border-gray-200 dark:border-gray-600">
                    <div class="flex items-center pl-3">
                        <input id="laravel-checkbox" type="checkbox" value="" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500">
                        <img class="ml-4 w-8 h-8 rounded" src="{{asset('blogImages/baby.jpeg')}}" alt="Default avatar">
    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-20 lg:py-16 lg:grid-cols-12">
            ...
            <div class="mr-auto place-self-center lg:col-span-6">
                ...
                <img class="hidden mx-auto lg:flex" src="{{asset('images/MOckUP.png')}}" alt="illustration">
            </div>             
        </div>
      </section>    
