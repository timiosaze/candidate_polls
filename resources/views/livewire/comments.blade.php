<div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-20 lg:px-6">
    <div class="mx-auto max-w-screen-sm mb-8 lg:mb-16">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Comments</h2>
        <a href="{{ route('comments') }}" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-xs px-5 py-2.5 mr-2 mb-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Random (10)</a>
    ...
    <div id="testimonial-carousel" class="relative" data-carousel="static">
        <div class="overflow-x-hidden overflow-y-visible relative mx-auto max-w-screen-md h-52 rounded-lg sm:h-48">
            ...
            <figure class="hidden mx-auto w-full max-w-screen-md" data-carousel-item>
                <blockquote>
                    <p class="text-lg font-medium text-gray-900 sm:text-2xl dark:text-white">"{{$comment->comment}}"</p>
                </blockquote>
                <figcaption class="flex justify-center items-center mt-6 space-x-3">
                    ...
                    <div class="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                        <div class="pr-3 font-medium text-gray-900 dark:text-white">{{$comment->user->name}}</div>
                        <div class="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">{{$comment->user->candidate->party->name}}</div>
                    </div>
                </figcaption>
            </figure>
